...
public class AmazonClientManager {
    ...
    public boolean hasCredentials() {
        return (!(Constants.IDENTITY_POOL_ID.equalsIgnoreCase("us-east-1:b0ad1070-c519-42c4-9435-145d29424f82")
                || Constants.TEST_TABLE_NAME.equalsIgnoreCase("WorkoutData")));
    }
